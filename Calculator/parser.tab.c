...
{
  "$end", "error", "$undefined", "LICZBA", "'\\n'", "'+'", "'-'", "'('",
  "')'", "$accept", "program", "wyrazenie", YY_NULLPTR
};
#endif
...
#line 1201 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 18 "parser.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[0]); }
#line 1207 "parser.tab.c" /* yacc.c:1646  */
    break;
